...
- Code checkpoint: `6abd75469`; the following state-document commit does not change reviewed code.
...
- Exact `default@OhosTestCompileArkTS`: PASS on 2026-08-22 for VNC checkpoint `6abd75469` before later unrelated Sheet-policy working-tree changes appeared.
- Exact `assembleHap`: PASS on the same VNC checkpoint worktree. Signed HAP SHA-256: `b731cfb4c9e516965404aa638d05a539f55c3da3c0c4985b8039814422914ffe`.
...
- Committed checkpoints: `9eadb35be`, `326f329f5`, `348b28083`, `aff7fdf03`, `2d9ce0024`, `2c9120e98`, `94fa21f8f`, `6abd75469`.
