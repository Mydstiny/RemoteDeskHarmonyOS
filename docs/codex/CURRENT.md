...
- HDC reproduction: SSH TCP/KEX/public-key auth/PTY/shell all completed; the
  ...
  on PID 18229 at 2026-08-06 17:36:30. The latest xterm-path run on
  `127.0.0.1:5555` (PID 10022) reached `page ready`/`report ready`, received
  input, and showed no `SIGABRT`, `Device lost`, `SurfaceFlush` or renderer crash.
