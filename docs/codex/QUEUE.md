...
- Finish the local-main VNC UX implementation handoff: run the final post-documentation gates, make the scoped local commit, and keep remote push/PR/remote-main merge out of this task.
